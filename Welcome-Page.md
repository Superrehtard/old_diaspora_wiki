...
#### こんにちは!! diasporaを楽しく始めて新しい人々に出会うための最初のtipsです。

1. 未登録であれば、**プロフィールにtagを5つ追加しましょう。**: これは他の人々があなたを見つけるために役立ちます。
2. **#tagsをフォローしてみましょう。**（検索バーで検索して"start following"をクリック）: tagをフォローするとあなたのストリームに表示され、似通った興味を持つ人と出会うのに役立ちます。そして、あたなが好きな話題が表示されるでしょう。
3. **あなたの発言にタグを追加して、publicとして投稿しましょう。**:これらのタグをフォローしている人のストリームに表示されます。
4. **shareを始めてみましょう。**どのように動くかはすぐに理解できるでしょう。
5. 質問があるなら、[FAQ](https://github.com/diaspora/diaspora/wiki/FAQ-for-Users) か [tutorials](http://diasporial.com/tutorials) もしくは#questionタグを付けてpublicとして投稿してください。
