...
##Menus
Make all sections in the right menu collapse/expandable for now; turn it into a customizable widget bar in the future (iGoogle functionality). Also add suggested contacts there.
