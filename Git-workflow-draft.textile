...
p. Create an account on GitHub and fork the Diaspora repository.
...
p. Establish connectivity between your GitHub account and your development machine.

# Generate an SSH key on your development machine. Here's a "good guide":http://github.com/guides/key-setup-redirect that gives you specific directions for whatever OS you're accessing the page with.
