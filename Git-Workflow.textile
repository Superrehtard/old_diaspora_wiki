...
p. To keep your development branch up to date, rebase your changes on top of the current state of the upstream master. Check out *<a href="#gitrebase1">What's git-rebase?</a>* below to learn more about rebasing.
