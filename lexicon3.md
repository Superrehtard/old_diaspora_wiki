...
• **The standard 1.8.7** implementation is written in C, as a single-pass interpreted language._  ([Wikipedia.org](http://en.wikipedia.org/wiki/Ruby_(programming_language) 2011) <a><table align="right" width="0" height="0" cellspacing="0" cellpadding="0" border="0"><tr><td>
